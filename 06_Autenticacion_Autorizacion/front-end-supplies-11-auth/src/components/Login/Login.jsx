...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    if (!formData.username.trim()) {
      newFieldErrors.username = "El CIF de Empresa es obligatorio";
    }
      ...
      <div className="login-container">
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="username">CIF de Empresa</label>
            <input
              type="text"
              id="username"
              name="username"
        ...
        <div className="demo-credentials">
          ...
          <div className="demo-list">
            <div className="demo-item">
              <strong>TechStore:</strong> B12345678 / 123456
            </div>
            <div className="demo-item">
              <strong>Digital Office:</strong> A87654321 / password123
            </div>
            <div className="demo-item">
              <strong>InnovaCorp:</strong> C11223344 / admin2025
            </div>
          </div>
        </div>
      </div>
